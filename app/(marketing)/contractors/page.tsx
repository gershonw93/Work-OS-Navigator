    ...
    <>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              <Link href="/why" className="inline-flex items-center gap-2 rounded-xl border border-line text-ink-soft font-semibold px-6 py-3 hover:bg-panel transition-colors">
                Why switch
              </Link>
            </div>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:py-28 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <Reveal delay={120} className="order-1 lg:order-2">
          ...
          <Link href="/ai" className="mt-7 inline-flex items-center gap-1.5 text-sm font-semibold text-accent-fg hover:gap-2.5 transition-all">
