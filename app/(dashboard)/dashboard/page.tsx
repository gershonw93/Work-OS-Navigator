...
export default function DashboardPage() {
  ...
  return (
    <div className="p-6 space-y-5">
      ...
      {/* Stat cards */}
      {stats?.isSub ? (
        /* PHONE: six boxes became one card, colour only where it carries a
           warning. DESKTOP (lg+): the six tiles it always had - the phone look
           stays on the phone, by decision. */
        <>
        ...
        <StatStrip label="Overview" className="lg:hidden" items={[
        ...
        <>
          ...
          {(((stats as GcStats | null)?.pendingApprovals ?? 0) > 0
            ...
            <div className="overflow-hidden rounded-2xl border border-line bg-panel lg:hidden">
        ...
        (() => {
          ...
          return (
            <div className="grid grid-cols-2 gap-4 lg:grid-cols-3 xl:grid-cols-6">
              ...
              <StatStrip label="Overview" className="col-span-full lg:hidden" items={[
                      ...
                      <>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-1.5 mt-1 flex-wrap">
                            ...
                            <span className="text-xs text-faint ml-auto shrink-0" title={absoluteTime(item.created_at)}>{timeAgo(item.created_at)}</span>
                          </div>
                        </div>
                      </>
                    )
