  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h1 className="text-2xl font-bold text-ink">Pay Apps</h1>
          ...
          <p className="text-xs text-faint mt-1">
            ...
            <Link href={`/projects/${params.id}/invoices`} className="text-accent-fg hover:underline">Bills from subs</Link>.
          </p>
        </div>
