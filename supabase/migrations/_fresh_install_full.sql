-- ============================================================
-- SyteNav FULL fresh-install schema (001 → 045).
-- Use ONLY on a brand-new/empty Supabase project — the base
-- schema (001-007) uses plain CREATE TABLE and will error if
-- the tables already exist. On an existing DB, run
-- _combined_008-045.sql instead.
-- ============================================================
