...
export const guide: Guide = {
  ...
  blocks: [
    ...
    { type: 'p', text: 'What it does not do, plainly: there is no critical path, no float or slack, and no baseline to compare as-planned against as-built. There is no resource levelling, and no import or export to MS Project or Primavera. It works in calendar days - there is no working-day calendar, so weekends and holidays are not skipped for you. And the cross-project month view is for admins and managers; everyone else gets their own job and their own day.' },
  ],
  links: [
