...
export const guide: Guide = {
  ...
  links: [
    { text: 'Plans start at $99 a month and include unlimited team members, subs and clients', href: '/pricing' },
