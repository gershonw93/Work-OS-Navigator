...
export const guide: Guide = {
  ...
  blocks: [
    ...
    { type: 'compare', title: 'Every invoice needs both', left: {
      ...
      items: [
        ...
        'Is there a change order behind anything extra? If not, use the change order tracking process before approval.',
    ...
    { type: 'checklist', title: 'Before approving any subcontractor invoice', items: [
      ...
      'Every line is within scope, or has an approved change order behind it. Check why the underlying change order paperwork must be dispute-ready.',
  ...
  links: [
    { text: 'If not, use the change order tracking process before approval', href: '/guides/how-to-track-change-orders' },
    { text: 'Check why the underlying change order paperwork must be dispute-ready', href: '/guides/change-order-documentation' },
