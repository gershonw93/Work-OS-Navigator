...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'warn', text: 'A LINE YOU EDIT BY HAND STOPS FOLLOWING. Once you change a date yourself, later cascades leave that line alone and tell you they did - your decision beats the arithmetic. LINKING IT AGAIN PUTS IT BACK: open its own row, pick what it comes after, and Save. A date you typed BEFORE you linked it does not count - setting a vendor\'s dates is how a line gets dates at all, and that is not a decision to ignore the trade ahead.' },
      { type: 'steps', items: [
