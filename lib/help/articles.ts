...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    category: 'workspace',
    keywords: ['directory', 'contact', 'sub', 'vendor', 'supplier', 'add', 'company', 'quick add', 'inspector', 'phone', 'duplicate', 'added twice', 'wrong phone number', 'tabs', 'projects tab', 'cut off', 'missing tab', 'company profile', 'name wrapping', 'trade', 'change trade', 'wrong trade', 'edit trade', 'spelling', 'typo', 'not showing up', 'sub missing'],
