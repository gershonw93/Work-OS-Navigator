...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'tip', text: 'WHO CAN DO THIS. Anyone whose role has Invoices - admins, managers, project managers and office staff by default. A project manager does not get the Financials summary tab, and that is deliberate; it does not stop them entering, approving or paying a bill here.' },
    ],
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'tip', text: 'A worker only ever sees the jobs they are assigned to and their own tasks, time, and photos. Anything beyond that follows the permission grid: if Worker is not ticked for Budget or Invoices, those screens say so rather than opening.' },
    ],
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'steps', items: [
        ...
        'Click a row to open that project\'s Payments page. On a phone each job shows Received, Paid out and Escrow - tap it for the rest and a link to the job.',
      ] },
