...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'text', text: 'A TRADE HELD ON A PERCENT STAYS BLOCKED UNTIL SOMEBODY SAYS HOW FAR ALONG THE ONE AHEAD IS. Type the percent on that line as it goes, or let it come from that sub\'s budget lines - rolled up by money, so a $90k line at 10% beside a $10k line at 100% is 19% done, not 55%. SyteNav will not tell a crew to turn up based on a number nobody has entered.' },
