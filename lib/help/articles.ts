...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  // ── Settings & Team ────────────────────────────────────────────────────────
  {
    ...
    category: 'settings',
    keywords: ['quickbooks', 'qbo', 'accounting', 'sync', 'integration', 'bookkeeping', 'customers', 'vendors', 'invoices', 'export', 'intuit', 'not synced', 'still open', 'receivable', 'applied payment', 'settles', 'double counted', 'twice', 'wrong invoice paid'],
    ...
    blocks: [
      ...
      { type: 'steps', items: [
        ...
        'Use Sync customers, Sync subs (vendors), Sync bills, Sync client invoices and Sync payments to push those records - invoices before payments, so each payment has its invoice to settle.',
