...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    category: 'settings',
    keywords: ['permissions', 'roles', 'access', 'restrict', 'view', 'edit', 'read only', 'field supervisor', 'security', 'who can edit', 'role preview', 'view as', 'preview a role', 'see as', 'impersonate'],
