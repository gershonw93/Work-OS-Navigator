...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'text', text: 'EACH ROW SAYS HOW SOON IT IS - "Today", "Tomorrow", "In 4 days" - and the list runs soonest first. The chip turns amber when that inspection is inside the warning window and nobody has marked the work ready, which is the same rule the email uses, so the screen and your inbox never disagree. Nothing is shown for a visit that has already happened or one more than a fortnight out; the date on the row says that better.' },
