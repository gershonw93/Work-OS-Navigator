...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'text', text: 'AND IF NOTHING ELSE IS TOUCHED, THERE IS NO REVIEW. A line with nothing waiting on it just saves. The review screen exists to stand between a date change and a batch of emails; with nobody to tell, it is a step that does nothing.' },
