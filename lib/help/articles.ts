...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'text', text: 'TWO WAYS OUT, AND THEY REACH DIFFERENT PEOPLE. "Send to someone" goes to ONE person outside your company, on a link, with no account needed. "Tell everyone on this job" goes to your team and the trades working on it - in the bell, by email and on their phone - with no link at all. Use the first for an expeditor or a lender; use the second when a change moves somebody else\'s work.' },
