...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    keywords: ['time', 'clock', 'punch', 'hours', 'gps', 'selfie', 'timesheet', 'attendance', 'no gps',
      ...
      'allowed location', 'why is my punch flagged', 'export hours'],
    ...
    blocks: [
      ...
      { type: 'text', text: '"THIS JOB HAS NO MAP LOCATION YET" means the job\'s address could not be found on a map (it may be missing, or a placeholder like "1 Test Lane"). Nothing is wrong with your phone. Whoever manages the job fixes it by correcting the address in project settings; until then every punch on that job is flagged, because there is nothing to check against.' },
