...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'text', text: 'Before anything is added it tells you how many lines it found and how many of them it could read an amount for, so a sheet it could not price is obvious straight away rather than after the fact. Tick "Bring the amounts in too" to keep the prices, or untick it to import just the line items and price them yourself. If some rows already exist as lines you will be asked to either skip those duplicates or update them with the sheet\'s amounts - either way nothing already on the budget is ever deleted.' },
