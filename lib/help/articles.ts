...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    keywords: [
      ...
      'lumber', 'lumber yard', 'trusses', 'mouldings', 'windows', 'supplier', 'material only',
  ...
  // ── Money: Budget ──────────────────────────────────────────────────────────
  {
    ...
    blocks: [
      ...
      { type: 'steps', items: [
        ...
        'Add options where you have them. Each one takes a brand, a price, a color swatch, a photo and a link to the product page - a selection is a visual decision, so give them something to look at. Got a whole fan deck? "Paste a list" takes one per line and works out which bit is the color, the price and the link.',
