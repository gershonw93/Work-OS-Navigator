...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'steps', items: [
        'On the Inspections tab, click Add Inspection (a site manager or sub can request one).',
        'Pick the inspection type, the contact/inspector to schedule with, and a preferred date and time.',
        'Under "Who schedules this?", assign the person who books inspections (e.g. the office). They get a notification to schedule it.',
        'When they confirm the date, mark it Scheduled — the requester is notified back.',
        'After the visit, mark it Passed or Failed — the requester (and scheduler) are notified of the result.',
      ] },
      { type: 'tip', text: 'Scheduled inspections also show on the Master Calendar timeline, color-coded by result (purple = upcoming, green = passed, red = failed).' },
    ],
