  ...
  },
  {
    ...
    blocks: [
      ...
      { type: 'steps', items: [
        ...
        'Pick the inspection type, the contact/inspector to schedule with, a preferred date and time, and assign who schedules it. Under that field the form names everyone who will actually be notified - read it before you send.',
