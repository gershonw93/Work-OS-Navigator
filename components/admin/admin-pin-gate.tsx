    ...
    <div className="flex min-h-[60vh] items-center justify-center">
      <form onSubmit={submit} className="w-full max-w-xs rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="mb-4 flex flex-col items-center text-center">
          ...
          <h2 className="text-base font-semibold text-slate-800">Enter admin code</h2>
          <p className="mt-1 text-xs text-slate-500">This unlocks the platform console for this browser.</p>
        </div>
        <input
          type="password"
          inputMode="numeric"
          ...
          placeholder="••••••"
          className="w-full rounded-lg border border-slate-200 px-3 py-2 text-center text-lg tracking-widest focus:border-slate-400 focus:outline-none"
        />
